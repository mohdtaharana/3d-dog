...
export function App() {
  ...
  return (
   ...
   <main>
    ...
    <Canvas id="canvas-elem" style={{width:"100vw",height:"100vh",position:"fixed",top:"0",left:"0",zIndex:"1",
      }}>
    <Dog/>
   </Canvas>
   <section id="section1">
    <nav>
      <div className="nav-elem"><svg xmlns="http://www.w3.org/2000/svg" fill='white' viewBox="0 0 401.23099 116.838">
      ...
      <div className="nav-elem"> <i className="ri-arrow-right-s-line"></i>Our Show Reel</div>
   ...
   <section id="section3">
    <div className="top">
      <div className="left">
        <h3>We are crafting <br />emoional <br />experiances aimed <br /> at improving <br /> results</h3>
      </div>
      <div className="right"></div>
    </div>
    <div className="bottom">
