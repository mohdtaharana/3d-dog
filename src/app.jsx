    ...
    <>
      <main className={isMenuOpen ? 'menu-open' : ''}>
        <div className="images">
          <img id="tomorrowland" src="/backgrounds/tommorowland.png" alt="Tomorrowland" />
          ...
          <img id="phone" src="/backgrounds/phone.png" alt="This Was Louise's Phone" />
          <img id="kikk" src="/backgrounds/kikk.png" alt="KIKK Festival 2018" />
          <img id="kennedy" src="/backgrounds/kennedy.png" alt="The Kennedy Center" />
          <img id="opera" src="/backgrounds/opera.png" alt="Royal Opera Of Wallonia" />
        </div>

        {/* Pointer events set to none when menu is open so clicks pass through to links */}
        <Canvas
          id="canvas-elem"
          style={{
            width: '100%',
            ...
            top: '0',
            left: '0',
            zIndex: isMenuOpen ? '60' : '1',
            pointerEvents: isMenuOpen ? 'none' : 'auto',
          }}
        >
          <Dog isMenuOpen={isMenuOpen} />
        </Canvas>
        ...
        <nav className="main-nav">
          ...
          <div className="nav-elem our-show-reel">
            <i className="ri-arrow-right-s-line"></i>Our Show Reel
          </div>

          <div className="nav-elem menu-toggle-btn" onClick={toggleMenu}>
        ...
        <div className={`menu-overlay ${isMenuOpen ? 'active' : ''}`}>
          ...
          <div className="menu-footer">
            <div className="showreel-btn">
              {/* <i className="ri-play-fill"></i> Watch our Showreel */}
            </div>
            <div className="social-links">
              <a href="#facebook">Facebook</a> / <a href="#instagram">Instagram</a> /{' '}
              <a href="#dribbble">Dribbble</a> / <a href="#twitter">Twitter</a> /{' '}
        ...
        <section id="section3">
          <div className="top">
            <div className="left">
              <h3>
                We are crafting <br />
                emoional <br />
                experiances aimed <br /> at improving <br /> results
              </h3>
            </div>
            <div className="right"></div>
          </div>
          <div className="bottom">
            ...
            <div className="right">
              <p>
                Dogstudio is a design & technology firm working globally from our offices based
                in Belgium and Chicago. Our strong focus on producing high quality & emotional
                brandings, digital products and experiences became a signature.
              </p>
              <p>
                We’re passionate about moving people and solving problems for the likes of
                Microsoft, The Museum of Science And Industry Of Chicago, The Kennedy Center of
                Washington, Dragone, Quanta Magazine, and many more.
              </p>
            </div>
          </div>
        </section>
